...
class TestCarServiceScenarios:
    ...
    def test_list_cars_by_available_status(self, tmpdir: str, car_data: list[Car], model_data: list[Model]):
        ...
        available_cars2 = service.get_cars(CarStatus.available)

        assert available_cars2 == available_cars
...
# car_service = CarService(f'd:\\111\\')
testCarServiceScenarios = TestCarServiceScenarios()
# testCarServiceScenarios._fill_initial_data(car_service, car_data(), model_data())
# testCarServiceScenarios.test_list_cars_by_available_status(f'd:\\111\\', car_data(), model_data())
testCarServiceScenarios.test_list_full_info_by_vin(f'd:\\111\\', car_data(), model_data())